...
- **Aardvark（Codex Security）— セキュリティ脆弱性自動修正エージェント**
  ...
  [元記事を読む](https://openai.com/index/introducing-aardvark/)
...
- **SIMA 2 — 3D仮想世界向けAIエージェント**
  ...
  [元記事を読む](https://deepmind.google/blog/sima-2-an-agent-that-plays-reasons-and-learns-with-you-in-virtual-3d-worlds/)

- **Gemini Deep Research（Gemini 3 Pro ベース）刷新**

  Gemini 3 Pro をベースとしたリサーチエージェントを大幅刷新。より高度な研究支援機能を提供。

  [元記事を読む](https://deepmind.google/blog/)

- **Agent2Agent（A2A）プロトコル — エージェント間相互運用性実現**

  Salesforce・Google Cloud が開発したエージェント間相互運用プロトコル。クロスプラットフォームエージェント構築と企業エコシステムの統合を可能化。

  [元記事を読む](https://blog.google/innovation-and-ai/infrastructure-and-cloud/google-cloud/ai-business-trends-report-2026/)

- **Google Research — エージェントシステムのスケーリング科学的分析**

  単一エージェントと4種のマルチエージェントアーキテクチャを比較評価。エージェントシステムの効率的スケーリング方法論を提示。

  [元記事を読む](https://research.google/blog/towards-a-science-of-scaling-agent-systems-when-and-why-agent-systems-work/)
...
- **Llama 4 Scout / Maverick リリース — 初のオープンウェイト・ネイティブマルチモーダルモデル**
  ...
  [元記事を読む](https://ai.meta.com/blog/llama-4-multimodal-intelligence/)
...
- **Devstral — SWE-Bench Verified 最高スコアのコーディングエージェント**
  ...
  [元記事を読む](https://mistral.ai/news/devstral)
...
- **MiniMax-M2.5 — 実世界環境での強化学習エージェント特化モデル**
  ...
  [元記事を読む](https://huggingface.co/blog/MiniMax-AI/forge-scalable-agent-rl-framework-and-algorithm)

- **mem-agent — 記憶機能を持つ 4B LLM エージェント**

  Python ツールと Markdown ファイルを使い記憶機能を持つ4BパラメータのLLMエージェント。GSPO で訓練。軽量でありながら持続的記憶を実現。

  [元記事を読む](https://huggingface.co/blog/driaforall/mem-agent-blog)
